...
const addService = async () => {
  ...
  if (serviceName) {
    ...
    (body.serviceName = serviceName), (body.description = description);
  }
...
const showAddService = () => {
  document.getElementsByClassName("add-service-container")[0].style.display =
    "block";
  document.getElementsByClassName("service-container")[0].style.display =
    "none";
};
