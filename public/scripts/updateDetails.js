const updateDetails = async (fieldList) => {
  ...
  user.address = !userDetails.address ? `please update your address..!!` : `${userDetails?.address?.area},</br>${userDetails?.address?.cityName}-${userDetails?.address?.pincode},</br>${userDetails?.address?.stateName}`;
